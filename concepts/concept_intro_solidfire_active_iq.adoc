...
若要深入瞭解 SolidFire Active IQ ，請參閱 https://docs.netapp.com/us-en/solidfire-active-iq/index.html["本文檔SolidFire Active IQ"^]。
...
* https://mysupport.netapp.com/site/tools/tool-eula/5ddb829ebd393e00015179b2["NetApp 支援網站 > Active IQ 工具"^]
